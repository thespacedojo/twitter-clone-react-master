...
class Profile extends React.Component {
  ...
  following() {
    if (this.props.currentUser.profile && this.props.currentUser.profile.followingIds) {
      return _.contains(this.props.currentUser.profile.followingIds, this.props.user._id)
    } else {
      return false
    }
  }
            ...
            <div className="col-md-8 col-lg-6">
              <ul id="tweet-stream" className="list-group">
                <li className="list-group-item">
                  <h4 className="list-group-item-heading">Latest Tweets for {user.username}</h4>
                </li>
